  ...
  return (
    <>
      ...
      */}
        ...
        <body
          className={`bg-background ${raleway.variable} mx-auto max-w-screen-xl`}
        >
          <Header />
          {children}
          <Footer />
...
function Header() {
  return (
    <header className='absolute top-0 left-0 right-0 isolate z-10 w-full max-w-screen-xl bg-black/20 py-4 px-8 text-black backdrop-blur-sm sm:fixed sm:left-[unset] sm:right-[unset] sm:text-white'>
